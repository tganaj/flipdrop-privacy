# Privacy Policy — Samsung Galaxy Store edition

**Last updated:** May 25, 2026

This Privacy Policy describes how "FlipDrop" ("the App", "we", "our") collects, uses, and shares information when you use our mobile application distributed through **Samsung Galaxy Store**.
...
If you choose to sign in with Google Play Games from Settings, the App receives your **Google Play Games player ID and display name** and uses them to identify your entries on the online leaderboard across devices. Sign-in is optional — the App is fully playable without it. Google Play Games is provided through Google Play Services, which is preinstalled on Samsung devices.
...
Optional sign-in that gives the App a stable cross-device identity for the leaderboard. Provided through Google Play Services, preinstalled on Samsung devices. See [Google's Privacy Policy](https://policies.google.com/privacy).
...
### In-app Billing
The in-app purchase "Remove Ads" is processed by Google Play Billing through Google Play Services on your Samsung device. We do not collect or receive your payment details — Google Play handles the transaction and only reports the purchase status back to the App.

For more information, see [Google Play Privacy Policy](https://play.google.com/about/play-terms/).

### Samsung Galaxy Store
The App is distributed through Samsung Galaxy Store. Samsung Electronics processes your installation and update requests according to its own terms. We do not receive personal information from Samsung Galaxy Store about who downloaded the App. See [Samsung's Privacy Policy](https://www.samsung.com/global/privacy/).
...
- We do not integrate Samsung Account or Samsung Health
...
- **`com.google.android.gms.permission.AD_ID`** — gives AdMob access to the Android advertising identifier (revocable from your device settings under Privacy → Ads).
...
- You can reset your advertising ID through your device settings (Settings → Privacy → Ads on Samsung devices).
...
**Developer:** Ing. Tomáš Ganaj
**Email:** t.ganaj@gmail.com

---

This app is developed by Ing. Tomáš Ganaj and is distributed through Samsung Galaxy Store. The same App is also available on Google Play.
